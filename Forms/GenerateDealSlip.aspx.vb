...
Partial Class Forms_GenerateDealSlip
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If IsPostBack = False Then
                ...
                vws_DealSlip.Columns.Add("CASE TransType WHEN 'P' THEN 'PURC' ELSE 'SELL' END AS Type")
                vws_DealSlip.Columns.Add("CASE DealSlipType WHEN 'D' THEN 'Deal' ELSE 'COST MEMO' END AS DealType")
                vws_DealSlip.Columns.Add("SecurityName")
                vws_DealSlip.Columns.Add("CustomerName")
                vws_DealSlip.Columns.Add("CompName as Company")
                ...
                vws_DealSlip.ColumnWidths.Add(200)
