<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendMailToDealer.aspx.cs"
    Inherits="Forms_SendMailToDealer" %>
...
<head id="Head1" runat="server">
    <title>Send Mail To Dealer</title>
    <base target="_self"/>   
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table id="Table1" width="90%" align="center" cellspacing="0" style="border: 0px;"
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btn_Send" runat="server" Text="Send Mail" ToolTip="Send Mail" CssClass="ButtonCSS"
