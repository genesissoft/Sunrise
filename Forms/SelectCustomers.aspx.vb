...
Partial Class Forms_SelectCustomers
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If IsPostBack = False Then
                btn_Ret.Attributes.Add("onclick", "return ReturnValues();")
    ...
    Private Function BuildCondition() As String
        Try
            ...
            If Session("RestrictedAccess") = "Y" Then
                strCond = " Where UM.UserId =" & Val(Session("UserId"))
            End If
            If Trim(txt_Name.Text) <> "" Then
                If Session("RestrictedAccess") = "Y" Then
                    strCond = " Where UM.UserId =" & Val(Session("UserId")) & " And " & Request.QueryString("SelectedFieldName") & " LIKE '%" & txt_Name.Text & "%'"
                    'strCond += strCond & " And " & Request.QueryString("SelectedFieldName") & " LIKE '%" & txt_Name.Text & "%'"
                Else
