<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false"
    CodeFile="CategoryMaster.aspx.vb" Inherits="Forms_CategoryMaster" Title="Category Master" %>
...
function Validation()
{
     if((document.getElementById ("ctl00_ContentPlaceHolder1_cbo_CustomerType").value)== "")
    { 
        AlertMessage('Validation','Please Select Customer Type',175,450);
        return false;   
    }

    if((document.getElementById ("ctl00_ContentPlaceHolder1_txt_CategoryName").value)== "")
    { 
                    ...
                    <ContentTemplate>
                        <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="0" width="45%">
                            ...
                            <tr align="left">
                                ...
                                <td>
                                    <asp:TextBox ID="txt_CategoryName" runat="server" CssClass="TextBoxCSS" Width="200px"></asp:TextBox><em><span
