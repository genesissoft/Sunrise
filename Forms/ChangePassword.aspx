<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false"
    CodeFile="ChangePassword.aspx.vb" Inherits="Forms_ChangePassword" Title="ChangePassword" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function Validation() {
            if (Trim(document.getElementById("ctl00_ContentPlaceHolder1_txt_OldPassword").value) == "") {
                AlertMessage('Validation', 'Please Enter Old Password.', 175, 450);
                return false;
            }
            if (Trim(document.getElementById("ctl00_ContentPlaceHolder1_txt_NewPassword").value) == "") {
                AlertMessage('Validation', 'Please Enter New Password.', 175, 450);
                return false;
            }
            if (Trim(document.getElementById("ctl00_ContentPlaceHolder1_txt_ConfirmPassword").value) == "") {
                AlertMessage('Validation', 'Please Enter Confirm Password.', 175, 450);
                return false;
            }
            ...
            if (document.getElementById("ctl00_ContentPlaceHolder1_txt_NewPassword").value != document.getElementById("ctl00_ContentPlaceHolder1_txt_ConfirmPassword").value) {
                AlertMessage('Validation', 'Your Password and Reentered Password Does Not Matched.', 175, 450);
                return false;
            }
            if (document.getElementById("ctl00_ContentPlaceHolder1_txt_OldPassword").value == document.getElementById("ctl00_ContentPlaceHolder1_txt_NewPassword").value) {
                AlertMessage('Validation', 'Your New Password can not be same as the Old password.', 175, 450);
                return false;
            }
    ...
    <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0">
        <tr align="left">
            <td class="SectionHeaderCSS">Change Password</td>
        </tr>
                            ...
                            <tr align="left">
                                ...
                                <td>
                                    <asp:TextBox ID="txt_OldPassword" runat="server" CssClass="TextBoxCSS" Width="200px"
                                        TextMode="Password"></asp:TextBox><em><span style="color: Red; vertical-align: super;">*</span></em>&nbsp;
                                </td>
                            </tr>
                            <tr align="left">
                                <td>New Password:
