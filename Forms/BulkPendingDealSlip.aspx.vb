...
Partial Class Forms_BulkPendingDealSlip
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If IsPostBack = False Then
                ...
                vws_DealSlip.Columns.Add(" Case dealtranstype when 'F' then CASE Financialdealtype WHEN 'F' THEN 'ToPur/ToSell' ELSE 'Normal' END  ELSE '' END AS Finandealtype")
