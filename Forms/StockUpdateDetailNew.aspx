<%@ Page Language="VB" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="false"
    CodeFile="StockUpdateDetailNew.aspx.vb" Inherits="Forms_StockUpdateDetail" Title="Stock Update Detail"
                ...
                <tr>
                    ...
                    <ContentTemplate>--%>
                        <table id="Table2" width="100%" align="center" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <ContentTemplate>
                                            <div id="div1" style="margin-top: 0px; overflow: auto; width: 1000px; padding-top: 0px;
                                                ...
                                                <asp:GridView ID="dg_dme" runat="server" PageSize="15" AllowPaging="false" CssClass="GridCSS"
                                                    ...
                                                    TabIndex="38" Width="1000px" AllowSorting="true" Height ="500px">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="YTMAnn" SortExpression="Yield">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_Yield" Width="40px" runat="server" Text='<%# container.dataitem("YTMAnn") %>'
                                                        ...
                                                        <asp:TemplateField HeaderText="YTCAnn" SortExpression="YTCAnn">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_YTC" Width="40px" runat="server" Text='<%# container.dataitem("YTCAnn") %>'
                            ...
                            <tr>
                                <td align="center" style="margin-top: 10px; height: 21px;">
