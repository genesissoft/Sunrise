...
Partial Class UserControl_searchtextbox

    Inherits System.Web.UI.UserControl

    Dim PgName As String = "#searchtextbox#"
    ...
    Public ReadOnly Property SearchButton() As HtmlImage
        Get
            Return btn
        End Get
    End Property
    ...
    <Category("Layout"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False), DefaultValue(400)> _
    Public Property FormWidth() As Int16
        Get
    ...
    Public Property ConditionalFieldId1() As String
        Get
            Return strCondCtrlId1
        End Get
        Set(ByVal value As String)
            strCondCtrlId1 = value
        End Set
    End Property
    ...
    <Category("Behavior"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False)>
    ...
    ' to get record accordig to company and year
    <Category("Behavior"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False)>
    Public Property CheckCompany() As Boolean
        Get
            Return blnCheckCompany
        End Get
        Set(ByVal value As Boolean)
            blnCheckCompany = value
        End Set
    End Property
    ...
    Public ReadOnly Property SearchTextBox() As TextBox
        ...
        End Get
    End Property
    <Category("Data"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False)>
    ...
    <Category("Behavior"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(True)>
    ...
    Protected Sub btn_Post_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Post.Click
        Try
            'arrSelValues = Split(Hid_RetValues.Value, "!")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If IsPostBack = False Then
                ...
                Hid_FormHeight.Value = FormHeight
                Hid_FormWidth.Value = FormWidth
            Else
            ...
            Hid_CheckComp.Value = blnCheckCompany.ToString.ToLower
        ...
        Catch ex As Exception
            ...
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "msg", "alert('" & ex.Message.Replace("'", " ") & "');", True)
        End Try
    End Sub
