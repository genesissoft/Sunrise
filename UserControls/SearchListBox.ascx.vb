...
Partial Class UserControl_searchlistbox
    ...
    <Category("Data"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False)>
    ...
    <Category("Behavior"), Description("The fields collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(False), Bindable(False)>
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Trim(ConditionalFieldId1 & "") <> "" Then
                ...
                Else
                    GetControlValue(ConditionalControl1, Hid_ConditionalFieldValue1, "")
                End If
                'very imp function
            End If
            ...
            If Trim(ConditionalFieldId2 & "") <> "" Then
                ...
                Else
                    GetControlValue(ConditionalControl2, Hid_ConditionalFieldValue2, "")
                End If
            End If
