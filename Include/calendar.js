...
topBackground    = "#ffc86c";         // #d7eef3 BG COLOR OF THE TOP FRAME
bottomBackground = "white";         // #e8f4f8 BG COLOR OF THE BOTTOM FRAME
tableBGColor     = "#edfdfd";         // #e7f7f7 BG COLOR OF THE BOTTOM FRAME'S TABLE
parenttableColor = "#003599";		//#c1cdd3
...
function showCalendar(dateField,TopVal,LeftVal) {
	...
	Prefs = "dependent=yes,titlebar=yes,width=230,height=230,left=" + LeftVal + ",top=" + TopVal
	winPrefs=Prefs;
    ...
    calDocFrameset = 
        "<HTML><HEAD><TITLE>Genesis Calendar</TITLE></HEAD>\n" +
...
function buildTopCalFrame() {
    ...
    var calDoc =
        ...
        "<CENTER>" +
        getMonthSelect() +
        "<INPUT NAME='year' VALUE='" + calDate.getFullYear() + "'TYPE=TEXT SIZE=4 MAXLENGTH=4 onChange='parent.opener.setYear()' Disabled>" +
        "</CENTER>" +
        "</TD>" +
        "</TR>" +
        "<TR>" +
