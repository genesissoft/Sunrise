(function (factory) {
    ...
    $.fn.jqFilter = function (arg) {
        ...
        var p = $.extend(true, {
            ...
            //numopts : ['eq','ne', 'lt', 'le', 'gt', 'ge', 'nu', 'nn', 'in', 'ni'],
            //stropts : ['eq', 'ne', 'bw', 'bn', 'ew', 'en', 'cn', 'nc', 'nu', 'nn', 'in', 'ni'],
            numopts: ['ge', 'eq', 'ne', 'lt', 'le', 'gt'],
            stropts: ['cn', 'eq', 'ne', 'bw', 'ew'],
        ...
        return this.each(function () {
            ...
            */
            ...
            this.createTableRowForRule = function (rule, group) {
                ...
                for (i = 0; i < op.length; i++) {
                    ...
                    if (ina !== -1) {
                        ...
                        if (that.p.ops[ina].oper == "cn" || that.p.ops[ina].oper == "ge") {
                            rule.op = that.p.ops[ina].oper;
                            selected =" selected='selected'";
                            str += "<option value='" + that.p.ops[ina].oper + "'" + selected + ">" + that.p.ops[ina].text + "</option>";
                        }
                        else {
                            str += "<option value='" + that.p.ops[ina].oper + "'>" + that.p.ops[ina].text + "</option>";
                        }
                    }
                }
            ...
            this.getStringForRule = function (rule) {
                ...
                else { ret = rule.field + " " + opUF + ((cm.sorttype != 'date' || val == '') ? " \"" + val + "\"" : "Convert(Date, \"" + val + "\",103)"); }
                return ret;
            ...
            return this.each(function () {
                ...
                if ($("#" + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
                    ...
                    $("#" + fid + "_search").bind('click', function () {
                        var sdata = {}, res, filters, SQLQuery;
                        fl = $("#" + fid);
                        fl.find(".input-elm:focus").change();
                        filters = fl.jqFilter('filterData');
                        SQLQuery = fl.jqFilter('toSQLString');
